...
class VehicleControlData(metaclass=Metaclass_VehicleControlData):
    ...
    def acceleration_pct(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'acceleration_pct' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
    ...
    def braking_pct(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'braking_pct' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
    ...
    def target_wheel_angle(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'target_wheel_angle' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
    ...
    def target_wheel_angular_rate(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'target_wheel_angular_rate' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
