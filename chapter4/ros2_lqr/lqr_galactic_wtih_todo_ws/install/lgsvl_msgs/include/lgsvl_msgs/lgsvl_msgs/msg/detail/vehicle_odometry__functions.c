...
lgsvl_msgs__msg__VehicleOdometry__are_equal(const lgsvl_msgs__msg__VehicleOdometry * lhs, const lgsvl_msgs__msg__VehicleOdometry * rhs)
{
  ...
  // rear_wheel_angle
  if (lhs->rear_wheel_angle != rhs->rear_wheel_angle) {
    return false;
  }
  return true;
}
  ...
  lgsvl_msgs__msg__VehicleOdometry * output)
{
  ...
  // rear_wheel_angle
  output->rear_wheel_angle = input->rear_wheel_angle;
  return true;
}
...
lgsvl_msgs__msg__VehicleOdometry__create()
{
  ...
  lgsvl_msgs__msg__VehicleOdometry * msg = (lgsvl_msgs__msg__VehicleOdometry *)allocator.allocate(sizeof(lgsvl_msgs__msg__VehicleOdometry), allocator.state);
  if (!msg) {
    return NULL;
  }
...
lgsvl_msgs__msg__VehicleOdometry__Sequence__init(lgsvl_msgs__msg__VehicleOdometry__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (lgsvl_msgs__msg__VehicleOdometry *)allocator.zero_allocate(size, sizeof(lgsvl_msgs__msg__VehicleOdometry), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  lgsvl_msgs__msg__VehicleOdometry__Sequence * array = (lgsvl_msgs__msg__VehicleOdometry__Sequence *)allocator.allocate(sizeof(lgsvl_msgs__msg__VehicleOdometry__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
lgsvl_msgs__msg__VehicleOdometry__Sequence__are_equal(const lgsvl_msgs__msg__VehicleOdometry__Sequence * lhs, const lgsvl_msgs__msg__VehicleOdometry__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!lgsvl_msgs__msg__VehicleOdometry__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  lgsvl_msgs__msg__VehicleOdometry__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(lgsvl_msgs__msg__VehicleOdometry);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    lgsvl_msgs__msg__VehicleOdometry * data =
      (lgsvl_msgs__msg__VehicleOdometry *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!lgsvl_msgs__msg__VehicleOdometry__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          lgsvl_msgs__msg__VehicleOdometry__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!lgsvl_msgs__msg__VehicleOdometry__copy(
