...
{
  const auto & item = *reinterpret_cast<const lgsvl_msgs::msg::Detection3D *>(
    get_const_function__Detection3DArray__detections(untyped_member, index));
  auto & value = *reinterpret_cast<lgsvl_msgs::msg::Detection3D *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<lgsvl_msgs::msg::Detection3D *>(
    get_function__Detection3DArray__detections(untyped_member, index));
  const auto & value = *reinterpret_cast<const lgsvl_msgs::msg::Detection3D *>(untyped_value);
  item = value;
}
