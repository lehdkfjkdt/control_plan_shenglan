...
struct Detection3DArray_
{
  ...
  using _detections_type =
    std::vector<lgsvl_msgs::msg::Detection3D_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<lgsvl_msgs::msg::Detection3D_<ContainerAllocator>>>;
  ...
  Type & set__detections(
    const std::vector<lgsvl_msgs::msg::Detection3D_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<lgsvl_msgs::msg::Detection3D_<ContainerAllocator>>> & _arg)
  {
