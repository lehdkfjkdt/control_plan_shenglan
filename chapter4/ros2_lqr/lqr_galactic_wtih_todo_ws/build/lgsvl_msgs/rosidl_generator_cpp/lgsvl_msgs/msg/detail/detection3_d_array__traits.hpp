...
// Member 'detections'
#include "lgsvl_msgs/msg/detail/detection3_d__traits.hpp"
...
inline void to_yaml(
  const lgsvl_msgs::msg::Detection3DArray & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const lgsvl_msgs::msg::Detection3DArray & msg)
{
