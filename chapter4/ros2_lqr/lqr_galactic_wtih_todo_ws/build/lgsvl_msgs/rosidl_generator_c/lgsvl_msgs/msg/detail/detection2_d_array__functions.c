...
bool
lgsvl_msgs__msg__Detection2DArray__are_equal(const lgsvl_msgs__msg__Detection2DArray * lhs, const lgsvl_msgs__msg__Detection2DArray * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  // detections
  if (!lgsvl_msgs__msg__Detection2D__Sequence__are_equal(
...
bool
lgsvl_msgs__msg__Detection2DArray__copy(
  const lgsvl_msgs__msg__Detection2DArray * input,
  lgsvl_msgs__msg__Detection2DArray * output)
{
  if (!input || !output) {
    return false;
  }
  ...
  // detections
  if (!lgsvl_msgs__msg__Detection2D__Sequence__copy(
...
lgsvl_msgs__msg__Detection2DArray__create()
{
  ...
  lgsvl_msgs__msg__Detection2DArray * msg = (lgsvl_msgs__msg__Detection2DArray *)allocator.allocate(sizeof(lgsvl_msgs__msg__Detection2DArray), allocator.state);
  if (!msg) {
    return NULL;
  }
...
lgsvl_msgs__msg__Detection2DArray__Sequence__init(lgsvl_msgs__msg__Detection2DArray__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (lgsvl_msgs__msg__Detection2DArray *)allocator.zero_allocate(size, sizeof(lgsvl_msgs__msg__Detection2DArray), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  lgsvl_msgs__msg__Detection2DArray__Sequence * array = (lgsvl_msgs__msg__Detection2DArray__Sequence *)allocator.allocate(sizeof(lgsvl_msgs__msg__Detection2DArray__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
bool
lgsvl_msgs__msg__Detection2DArray__Sequence__are_equal(const lgsvl_msgs__msg__Detection2DArray__Sequence * lhs, const lgsvl_msgs__msg__Detection2DArray__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!lgsvl_msgs__msg__Detection2DArray__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
lgsvl_msgs__msg__Detection2DArray__Sequence__copy(
  const lgsvl_msgs__msg__Detection2DArray__Sequence * input,
  lgsvl_msgs__msg__Detection2DArray__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(lgsvl_msgs__msg__Detection2DArray);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    lgsvl_msgs__msg__Detection2DArray * data =
      (lgsvl_msgs__msg__Detection2DArray *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!lgsvl_msgs__msg__Detection2DArray__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          lgsvl_msgs__msg__Detection2DArray__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!lgsvl_msgs__msg__Detection2DArray__copy(
