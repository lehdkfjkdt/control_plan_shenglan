...
#include "lgsvl_msgs/msg/detail/detected_radar_object__rosidl_typesupport_fastrtps_cpp.hpp"
...
static size_t _DetectedRadarObject__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_DetectedRadarObject(full_bounded, is_plain, 0);
