...
struct SignalArray_
{
  ...
  _header_type header;
  using _signals_type =
    std::vector<lgsvl_msgs::msg::Signal_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<lgsvl_msgs::msg::Signal_<ContainerAllocator>>>;
  ...
  Type & set__signals(
    const std::vector<lgsvl_msgs::msg::Signal_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<lgsvl_msgs::msg::Signal_<ContainerAllocator>>> & _arg)
  {
    this->signals = _arg;
    return *this;
  }
