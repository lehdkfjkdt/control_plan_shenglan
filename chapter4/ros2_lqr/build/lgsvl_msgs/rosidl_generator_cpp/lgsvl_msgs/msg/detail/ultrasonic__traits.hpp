  ...
  std::ostream & out)
{
  ...
  // member: minimum_distance
  {
    ...
    rosidl_generator_traits::value_to_yaml(msg.minimum_distance, out);
  }
  out << "}";
...
inline void to_yaml(
  const lgsvl_msgs::msg::Ultrasonic & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const lgsvl_msgs::msg::Ultrasonic & msg)
{
