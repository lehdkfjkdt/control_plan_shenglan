...
struct DetectedRadarObjectArray_
{
  ...
  _header_type header;
  using _objects_type =
    std::vector<lgsvl_msgs::msg::DetectedRadarObject_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<lgsvl_msgs::msg::DetectedRadarObject_<ContainerAllocator>>>;
  ...
  Type & set__objects(
    const std::vector<lgsvl_msgs::msg::DetectedRadarObject_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<lgsvl_msgs::msg::DetectedRadarObject_<ContainerAllocator>>> & _arg)
  {
    this->objects = _arg;
    return *this;
  }
