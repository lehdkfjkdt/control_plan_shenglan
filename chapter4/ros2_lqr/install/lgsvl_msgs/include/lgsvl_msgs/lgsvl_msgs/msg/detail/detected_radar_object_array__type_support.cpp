...
void fetch_function__DetectedRadarObjectArray__objects(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const lgsvl_msgs::msg::DetectedRadarObject *>(
    get_const_function__DetectedRadarObjectArray__objects(untyped_member, index));
  auto & value = *reinterpret_cast<lgsvl_msgs::msg::DetectedRadarObject *>(untyped_value);
  value = item;
}

void assign_function__DetectedRadarObjectArray__objects(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<lgsvl_msgs::msg::DetectedRadarObject *>(
    get_function__DetectedRadarObjectArray__objects(untyped_member, index));
  const auto & value = *reinterpret_cast<const lgsvl_msgs::msg::DetectedRadarObject *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember DetectedRadarObjectArray_message_member_array[2] = {
  ...
  },
  {
    ...
    fetch_function__DetectedRadarObjectArray__objects,  // fetch(index, &value) function pointer
    assign_function__DetectedRadarObjectArray__objects,  // assign(index, value) function pointer
