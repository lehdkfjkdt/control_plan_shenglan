...
lgsvl_msgs__msg__Detection2D__are_equal(const lgsvl_msgs__msg__Detection2D * lhs, const lgsvl_msgs__msg__Detection2D * rhs)
{
  ...
  // bbox
  if (!lgsvl_msgs__msg__BoundingBox2D__are_equal(
      &(lhs->bbox), &(rhs->bbox)))
  {
    return false;
  }
...
lgsvl_msgs__msg__Detection2D__create()
{
  ...
  lgsvl_msgs__msg__Detection2D * msg = (lgsvl_msgs__msg__Detection2D *)allocator.allocate(sizeof(lgsvl_msgs__msg__Detection2D), allocator.state);
  if (!msg) {
    return NULL;
  }
...
lgsvl_msgs__msg__Detection2D__Sequence__init(lgsvl_msgs__msg__Detection2D__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (lgsvl_msgs__msg__Detection2D *)allocator.zero_allocate(size, sizeof(lgsvl_msgs__msg__Detection2D), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  lgsvl_msgs__msg__Detection2D__Sequence * array = (lgsvl_msgs__msg__Detection2D__Sequence *)allocator.allocate(sizeof(lgsvl_msgs__msg__Detection2D__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
lgsvl_msgs__msg__Detection2D__Sequence__are_equal(const lgsvl_msgs__msg__Detection2D__Sequence * lhs, const lgsvl_msgs__msg__Detection2D__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!lgsvl_msgs__msg__Detection2D__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  lgsvl_msgs__msg__Detection2D__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(lgsvl_msgs__msg__Detection2D);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    lgsvl_msgs__msg__Detection2D * data =
      (lgsvl_msgs__msg__Detection2D *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!lgsvl_msgs__msg__Detection2D__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          lgsvl_msgs__msg__Detection2D__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!lgsvl_msgs__msg__Detection2D__copy(
